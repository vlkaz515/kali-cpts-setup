...
# privesc subfolders
PRIV="$WIN/privesc"
check_file "privesc/README.md"                        "$PRIV/README.md"
check_file "privesc/SeImpersonatePrivilege/"          "$PRIV/SeImpersonatePrivilege"
check_file "privesc/SeDebugPrivilege/psgetsys.ps1"    "$PRIV/SeDebugPrivilege/psgetsys.ps1"
check_file "privesc/SeTakeOwnershipPrivilege/"        "$PRIV/SeTakeOwnershipPrivilege"
check_file "privesc/SeBackupPrivilege/"               "$PRIV/SeBackupPrivilege"
check_file "privesc/SeLoadDriverPrivilege/"           "$PRIV/SeLoadDriverPrivilege"
check_file "privesc/KernelExploits/"                  "$PRIV/KernelExploits"
check_file "privesc/UACBypass/UACME/"                 "$PRIV/UACBypass/UACME"
check_file "privesc/ServiceMisconfig/accesschk.exe"   "$PRIV/ServiceMisconfig/accesschk.exe"
check_file "privesc/ServiceMisconfig/SharpUp.exe"     "$PRIV/ServiceMisconfig/SharpUp.exe"
check_file "privesc/CredentialTheft/"                 "$PRIV/CredentialTheft"
check_file "privesc/Enumeration/"                     "$PRIV/Enumeration"
check_file "privesc/DSInternals/"                     "$PRIV/DSInternals"
# root-level duplicates
check_file "JuicyPotato.exe"      "$WIN/JuicyPotato.exe"
check_file "PrintSpoofer.exe"     "$WIN/PrintSpoofer.exe"
check_file "RoguePotato.exe"      "$WIN/RoguePotato.exe"
check_file "psgetsys.ps1"         "$WIN/psgetsys.ps1"
check_file "EnableAllTokenPrivs.ps1" "$WIN/EnableAllTokenPrivs.ps1"
check_file "SharpUp.exe"          "$WIN/SharpUp.exe"
check_file "accesschk.exe"        "$WIN/accesschk.exe"
check_file "Sysinternals_EULA.reg" "$WIN/Sysinternals_EULA.reg"
check_file "CVE-2021-1675.ps1"    "$WIN/CVE-2021-1675.ps1"
check_file "Watson.exe"           "$WIN/Watson.exe"
check_file "wesng/"               "$WIN/wesng"
check_file "jaws-enum.ps1"        "$WIN/jaws-enum.ps1"
check_file "Lnkbomb/"             "$WIN/Lnkbomb"
